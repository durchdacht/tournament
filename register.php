...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	if(isset($_POST["register_team"]))
	{
		...
		curl_setopt_array($curl, [ 
  			...
  			CURLOPT_POST => 1,
  			CURLOPT_POSTFIELDS => [
  				"secret" => "6Lf434UUAAAAAPhRC5zX_SUQVzh5lVaiZtn2YaMk",
		...
		if(!$response->success)
		{
			$_SESSION["MSG"] = "you did not complete the captcha";
		...
		<center>
			...
			<div class = "container-bottom"> 
				...
				<form method="post">
					...
					<input class = "form spacer" type="text" name="player1_steam" <?php if(isset($_SESSION["player1_steam"])) { echo "value = '" . $_SESSION["player1_steam"] . "'"; } ?> placeholder="captain steam url" autocomplete="off" required>
					...
					<input class = "form spacer" type="text" name="player2_steam" <?php if(isset($_SESSION["player2_steam"])) { echo "value = '" . $_SESSION["player2_steam"] . "'"; } ?> placeholder="player 2 steam url" autocomplete="off" required>
					...
					<input class = "form spacer" type="text" name="player3_steam" <?php if(isset($_SESSION["player3_steam"])) { echo "value = '" . $_SESSION["player3_steam"] . "'"; } ?> placeholder="player 3 steam url" autocomplete="off" required>
					...
					<input class = "form spacer" type="text" name="player4_steam" <?php if(isset($_SESSION["player4_steam"])) { echo "value = '" . $_SESSION["player4_steam"] . "'"; } ?> placeholder="player 4 steam url" autocomplete="off" required>
					...
					<input class = "form spacer" type="text" name="player5_steam" <?php if(isset($_SESSION["player5_steam"])) { echo "value = '" . $_SESSION["player5_steam"] . "'"; } ?> placeholder="player 5 steam url" autocomplete="off" required>
					...
					<input class = "form spacer" type="text" name="player6_steam" <?php if(isset($_SESSION["player6_steam"])) { echo "value = '" . $_SESSION["player6_steam"] . "'"; } ?> placeholder="player 6 steam url" autocomplete="off">
					* not required
					<br> <br>

					<div class="g-recaptcha" data-theme="dark" data-sitekey="6Lf434UUAAAAAImR6artliNs_DIWO_TnBQsCjzo4"> </div>
